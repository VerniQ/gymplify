...
BEGIN
    ...
    IF v_personal_plan_count > 0 THEN
        RAISE_APPLICATION_ERROR(-20403, 'Nie można usunąć trenera ID ' || :OLD.trainer_id || ', ponieważ jest przypisany do ' || v_personal_plan_count || ' osobistych planów treningowych.');
    END IF;
END;
/