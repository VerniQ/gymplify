...
CREATE OR REPLACE PACKAGE BODY PKG_PERSONAL_PLAN_MGMT AS
    ...
    PROCEDURE AssignPlanToUser(
        ...
        v_is_valid BOOLEAN;
    BEGIN
        v_is_valid := fn_validate_entities(p_user_id, p_trainer_id, p_plan_id);
    ...
    BEGIN
        IF fn_validate_entities(p_user_id, NULL, p_plan_id) THEN
            NULL;
        END IF;
        IF p_trainer_id IS NOT NULL THEN
            IF fn_validate_entities(NULL, p_trainer_id, NULL) THEN
                NULL;
            END IF;
        END IF;
    ...
    BEGIN
        ...
        v_is_valid := fn_validate_entities(NULL, p_new_trainer_id, p_new_plan_id);
    ...
    BEGIN
        IF fn_validate_entities(p_user_id, NULL, NULL) THEN
            NULL;
        END IF;
    ...
    BEGIN
        IF fn_validate_entities(NULL, NULL, p_plan_id) THEN
            NULL;
        END IF;
